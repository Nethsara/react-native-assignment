          ...
          <TouchableOpacity onPress={() => openPicker("video")}>
            {form.video ? (
              ...
              <View className="w-full h-40 px-4 rounded-2xl border border-black-200 flex justify-center items-center">
                <View className="w-14 h-14 border border-dashed border-black-100 flex justify-center items-center">
                  <Image
                    source={icons.upload}
                    resizeMode="contain"
                    alt="upload"
            ...
            {form.thumbnail ? (
              ...
              <View className="w-full h-16 px-4 rounded-2xl border-2 border-black-200 flex justify-center items-center flex-row space-x-2">
                <Image
                  ...
                  className="w-5 h-5"
                />
                <Text className="text-base font-pmedium">Choose a file</Text>
              </View>
            )}
          </TouchableOpacity>
        </View>
